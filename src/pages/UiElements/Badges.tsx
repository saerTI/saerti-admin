...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Saer TI Software"
        description="This is React.js Badges Dashboard page for SAER TI - React.js Tailwind CSS Admin Dashboard Template"
      />
