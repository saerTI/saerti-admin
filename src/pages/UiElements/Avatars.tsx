...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Saer TI Software"
        description="This is React.js Avatars Dashboard page for SAER TI - React.js Tailwind CSS Admin Dashboard Template"
      />
