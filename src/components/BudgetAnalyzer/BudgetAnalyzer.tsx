...
import { Loader2, TrendingUp, MapPin, Building, Calculator, FileText, AlertTriangle } from 'lucide-react';
import { budgetAnalysisService, useBudgetAnalysis } from '../../services/budgetAnalysisService';
import { AnalysisResults } from './AnalysisResults';
import type { ProjectData, AnalysisConfig } from '../../types/budgetAnalysis';
...
export const BudgetAnalyzer: React.FC = () => {
  ...
  // Hook personalizado para análisis
  const {
    isLoading,
    isValidating,
    analysis,
  ...
  }, [formData.type, formData.location, formData.area]);
